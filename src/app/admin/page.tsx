  ...
  if (!isAdminEmail(email)) {
    return (
      <Panel title="Moderation queue">
        <p>
          This console is restricted to moderators. Sign in with an account listed in{" "}
          <code>ADMIN_EMAILS</code> to review the queue.
        </p>
    ...
    >
      <header style={{ marginBottom: "1.5rem" }}>
        ...
        <p style={{ color: "var(--ink-2)", marginTop: "0.25rem" }}>
          {pending} pending · {items.length} total. Signed in as {email}.
        </p>
      </header>
